...
public class EmployeeService {
	...
	public void checkcity(String Empserviceno) throws InvalidPincode {
		// TODO Auto-generated method stub
			
			if(Empserviceno.endsWith("011")) {
				
				System.out.println(Empserviceno.substring(6,9)+":"+"Delhi");
			}
			else if(Empserviceno.endsWith("022")) {
				System.out.println(Empserviceno.substring(6,9)+":"+"Mumbai");
				
			} 
			else if(Empserviceno.endsWith("080")) {
				System.out.println(Empserviceno.substring(6,9)+":"+"Bangalore");
			}
			
			else if(Empserviceno.endsWith("020")) {
				System.out.println(Empserviceno.substring(6,9)+":"+"Pune");
			}
			else {
				throw new InvalidPincode("Wrong Pin Code of "+Empserviceno);
			}
